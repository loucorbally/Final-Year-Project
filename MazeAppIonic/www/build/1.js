...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MenuExample", function() { return MenuExample; });
...
var MenuExample = /** @class */ (function () {
    function MenuExample(menu) {
        this.menu = menu;
    }
    MenuExample.prototype.openFirst = function () {
        this.menu.enable(true, 'first');
        this.menu.open('first');
    };
    MenuExample.prototype.openEnd = function () {
        this.menu.open('end');
    };
    MenuExample.prototype.openCustom = function () {
...
var TutorialPage = /** @class */ (function () {
    ...
    TutorialPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-tutorial',template:/*ion-inline-start:"/Users/louisecorbally/Desktop/Final-Year-Project/MazeAppIonic/src/pages/tutorial/tutorial.html"*/'<ion-header no-shadow>\n  <ion-navbar>\n    <ion-buttons end *ngIf="showSkip">\n      <button ion-button (click)="startApp()" color= #7e57ff >{{ \'TUTORIAL_SKIP_BUTTON\' | translate}}</button>\n    </ion-buttons>\n    <ion-searchbar></ion-searchbar>\n  </ion-navbar>\n</ion-header>\n\n\n\n<ion-content no-bounce>\n  <ion-slides pager="true" dir="{{dir}}" (ionSlideWillChange)="onSlideChangeStart($event)">\n    <ion-slide *ngFor="let slide of slides">\n      <img [src]="slide.image" class="slide-image" />\n      <h2 class="slide-title" [innerHTML]="slide.title"></h2>\n      <p [innerHTML]="slide.description"></p>\n    </ion-slide>\n    <ion-slide>\n      <img src="assets/img/maze.png" class="slide-image" />\n      <h2 class="slide-title">{{ \'TUTORIAL_SLIDE4_TITLE\' | translate }}</h2>\n      <button ion-button icon-end large clear (click)="startApp()">\n        {{ \'TUTORIAL_CONTINUE_BUTTON\' | translate }}\n        <ion-icon name="arrow-forward"></ion-icon>\n      </button>\n    </ion-slide>\n  </ion-slides>\n</ion-content>\n'/*ion-inline-end:"/Users/louisecorbally/Desktop/Final-Year-Project/MazeAppIonic/src/pages/tutorial/tutorial.html"*/
        }),
