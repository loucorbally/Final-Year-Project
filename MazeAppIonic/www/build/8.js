...
var ItemDetailPage = /** @class */ (function () {
    ...
    ItemDetailPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-item-detail',template:/*ion-inline-start:"/Users/louisecorbally/Desktop/Final-Year-Project/MazeAppIonic/src/pages/item-detail/item-detail.html"*/'<ion-header>\n\n  <ion-navbar>\n    <ion-title>{{ item.name }}</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n  <div class="item-profile" text-center #profilePic [style.background-image]="\'url(\' + item.profilePic + \')\'">\n  </div>\n  <!-- Question 1 -->\n  <ion-card>\n\n    <ion-card-header>\n      Card Header\n    </ion-card-header>\n  \n    <ion-card-content>\n      <!-- Add card content here! -->\n    </ion-card-content>\n  \n  </ion-card>\n<!-- Question 2 -->\n  <ion-card>\n\n    <ion-card-header>\n      Card Header\n    </ion-card-header>\n  \n    <ion-card-content>\n      <!-- Add card content here! -->\n    </ion-card-content>\n  \n  </ion-card>\n  \n<!-- Question 3 -->\n  <ion-card>\n\n    <ion-card-header>\n      Card Header\n    </ion-card-header>\n  \n    <ion-card-content>\n      <!-- Add card content here! -->\n    </ion-card-content>\n  \n  </ion-card>\n\n  <div class="item-detail" padding>\n    <h2>{{item.name}}</h2>\n    <p>{{item.about}}</p>\n  </div>\n</ion-content>'/*ion-inline-end:"/Users/louisecorbally/Desktop/Final-Year-Project/MazeAppIonic/src/pages/item-detail/item-detail.html"*/
        }),
